...
describe('model generation', () => {
  it('createAddresses returns addresses for a wallet', async () => {
    ...
    const actual = await generateModel(api, wallets);
    ...
    expect(actual.scriptHashes).toEqual(
      Object.fromEntries(Object.values(basicTestData.blockchain.scriptHashes)
        .map((e) => ({
          ...e,
          info: basicTestData.usedAddresses
            .find((a) => a.scriptHash === e.scriptHash),
        }))
